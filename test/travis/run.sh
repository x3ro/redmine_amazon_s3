...
# Taken from https://github.com/jkraemer/redmine_percent_done/blob/step-five/travis.sh
# via https://jkraemer.net/2015/11/testing-a-redmine-plugin-with-travis-ci
...
mv $TESTSPACE/database.yml config/database.yml
mv $TESTSPACE/amazon_s3.yml config/amazon_s3.yml
...
bundle exec rake amazon_s3:test
